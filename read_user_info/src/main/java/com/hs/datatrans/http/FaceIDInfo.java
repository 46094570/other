...
import com.hs.datatrans.entity.face.DPersonalFaceIdInfoVo;
...
public class FaceIDInfo {


    public static void main(String[] args) throws IOException, ParseException {
        Sheet sheet = DxiangInfoBasicConfig.getSheet();
        FaceIDInfo bd = new FaceIDInfo();
        bd.getUserFaceInfo(sheet);
    }
     ...
     */
    public void getUserFaceInfo(Sheet sheet) {
        //初始化发送请求参数
        ...
        for (int i = startIndex; i <= sheet.getLastRowNum(); i++) {
            ...
            //转换
            DPersonalFaceIdInfoVo faceIdInfoVo = JSONObject.parseObject(decodeInfo, DPersonalFaceIdInfoVo.class);
            System.out.println("qianpenId:" + qpId + ",faceIdInfoVo:\r\n" + faceIdInfoVo);
