...
import com.hs.datatrans.entity.linkman.DLinkman;
...
public class ContactInfo {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        ContactInfo bd = new ContactInfo();
        bd.getUserContact(sheet);
    }
     ...
     */
    public void getUserContact(Sheet sheet) throws IOException, ParseException {
        //初始化发送请求参数
        ...
        for (int i = startIndex; i <= sheet.getLastRowNum(); i++) {
            ...
            //转换
            List<DLinkman> contacts = JSONObject.parseArray(decodeInfo, DLinkman.class);
            System.out.println("qianpenId:" + qpId + ",contacts:\r\n" + contacts);
