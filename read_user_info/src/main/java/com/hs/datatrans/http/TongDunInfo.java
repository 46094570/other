...
import com.hs.datatrans.entity.tongdun.DTDReportInfoVo;
...
public class TongDunInfo {
    ...
    public void getUserBdList(Sheet sheet) throws IOException, ParseException {
        ...
        for (int i = startIndex; i <= sheet.getLastRowNum(); i++) {
            ...
            //转换
            DTDReportInfoVo reportInfo = JSONObject.parseObject(decodeInfo, DTDReportInfoVo.class);
            System.out.println("qianpenId:" + qpId + ",reportInfo:\r\n" + reportInfo);
